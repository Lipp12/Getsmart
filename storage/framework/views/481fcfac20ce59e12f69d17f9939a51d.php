        ...
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-7">
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg card-hover border border-orange-100 flex flex-col text-center">
                    <div class="p-3 pb-0">
                        <img src="<?php echo e($c['img']); ?>" class="h-48 w-full object-cover rounded-xl" alt="<?php echo e($c['title']); ?>">
                    </div>
                    <div class="p-6 flex-1 flex flex-col">
                        <h4 class="font-bold text-base mb-4 text-gray-800"><?php echo e($c['title']); ?></h4>
                        <div class="flex justify-between text-xs font-semibold text-gray-500 mb-2">
                            <span>Achieved: <?php echo e($c['achieved']); ?></span>
                            <span class="text-gs-orange font-bold">Target: <?php echo e($c['target']); ?></span>
                        </div>
                        <div class="w-full bg-gray-100 h-3 mb-5 rounded-full overflow-hidden">
                            <div class="bg-gradient-to-r from-gs-orange to-orange-400 h-3 rounded-full progress-bar" style="width: <?php echo e($c['percent']); ?>%"></div>
                        </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-5">
                ...
                <div class="member-card bg-white rounded-2xl p-5 text-center shadow-md border border-gray-100 card-hover cursor-pointer group">
                    <div class="overflow-hidden rounded-full w-20 h-20 mx-auto mb-4 ring-4 ring-gs-blue/10 group-hover:ring-gs-orange/40 transition-all duration-300">
                        <img src="https://i.pravatar.cc/150?img=<?php echo e($m['img']); ?>" 
                             class="w-full h-full object-cover" alt="<?php echo e($m['name']); ?>">
                    </div>
                    <h4 class="font-bold text-xs text-gray-800 leading-snug mb-1"><?php echo e($m['name']); ?></h4>
                    <p class="text-[11px] text-gray-400"><?php echo e($m['role']); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<?php /**PATH E:\laragon\www\NewFile\resources\views/welcome.blade.php ENDPATH**/ ?>